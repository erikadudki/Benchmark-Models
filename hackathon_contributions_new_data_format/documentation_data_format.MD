...
**TODO** This will no longer be the input table, what else is allowed here? (All parameters listed here are expected to have been turned into fixed 
...
- `observableParameters` [STRING OR NULL]
  ...
  **TODO** Change to `placeholder${N}` for clarity? Same for observable and noise
  
  **TODO** No placeholder* parameter must remain in the model?
